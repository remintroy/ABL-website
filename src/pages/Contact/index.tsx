    ...
    <>
      <section className="container my-10 flex flex-col sm:flex-row gap-10 mx:gap-0">
        <div className="sm:w-1/2 p-4">
            <img className="w-full max-w-xl" src="/images/banner-03.jpg" alt="Contact banner image" />
        </div>
        <div className="sm:w-1/2 p-4">
          ...
          <div className="py-10 flex flex-col justify-center items-center gap-2">
            <input
              className="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
              type="text"
              placeholder="name"
            />
            <input
